...
var _tunguski$elm_ast$Ast_Helpers$name = function (p) {
	return A2(
		_Bogdanp$elm_combine$Combine_ops['<*>'],
		A2(_Bogdanp$elm_combine$Combine_ops['<$>'], _elm_lang$core$String$cons, p),
		_Bogdanp$elm_combine$Combine$regex('[a-zA-Z0-9_]*'));
};
var _tunguski$elm_ast$Ast_Helpers$upName = _tunguski$elm_ast$Ast_Helpers$name(_Bogdanp$elm_combine$Combine_Char$upper);
var _tunguski$elm_ast$Ast_Helpers$multiLineComment = _Bogdanp$elm_combine$Combine$lazy(
	function (_p0) {
		var _p1 = _p0;
		return A2(
			_Bogdanp$elm_combine$Combine_ops['<$>'],
...
var _tunguski$elm_ast$Ast_Helpers$singleLineComment = _Bogdanp$elm_combine$Combine$lazy(
	function (_p2) {
		var _p3 = _p2;
		return A2(
			_Bogdanp$elm_combine$Combine_ops['<*'],
			...
			A2(
				...
				A2(
					...
					_Bogdanp$elm_combine$Combine$succeed('end'))));
	});
var _tunguski$elm_ast$Ast_Helpers$comments = _Bogdanp$elm_combine$Combine$lazy(
	function (_p4) {
		var _p5 = _p4;
		return A2(_Bogdanp$elm_combine$Combine_ops['<|>'], _tunguski$elm_ast$Ast_Helpers$singleLineComment, _tunguski$elm_ast$Ast_Helpers$multiLineComment);
	});
var _tunguski$elm_ast$Ast_Helpers$andComments = function (parser) {
			...
			return A2(
				...
				_Bogdanp$elm_combine$Combine$many1(
					_Bogdanp$elm_combine$Combine$choice(
						{
							ctor: '::',
							_0: _tunguski$elm_ast$Ast_Helpers$comments,
							_1: {
								ctor: '::',
								_0: parser,
								_1: {ctor: '[]'}
...
var _tunguski$elm_ast$Ast_Helpers$spaces = _tunguski$elm_ast$Ast_Helpers$andComments(
	_Bogdanp$elm_combine$Combine$regex('[ \t]*'));
var _tunguski$elm_ast$Ast_Helpers$initialSymbol = function (k) {
	return A2(
		_Bogdanp$elm_combine$Combine_ops['<*'],
		_Bogdanp$elm_combine$Combine$string(k),
		_tunguski$elm_ast$Ast_Helpers$spaces);
};
var _tunguski$elm_ast$Ast_Helpers$spaces_ = _tunguski$elm_ast$Ast_Helpers$andComments(
	_Bogdanp$elm_combine$Combine$regex('[ \t]+'));
var _tunguski$elm_ast$Ast_Helpers$wsAndComments = _tunguski$elm_ast$Ast_Helpers$andComments(_Bogdanp$elm_combine$Combine$whitespace);
var _tunguski$elm_ast$Ast_Helpers$between_ = function (p) {
	return A2(_Bogdanp$elm_combine$Combine$between, p, p);
};
var _tunguski$elm_ast$Ast_Helpers$symbol = function (k) {
	return A2(
		_tunguski$elm_ast$Ast_Helpers$between_,
		_tunguski$elm_ast$Ast_Helpers$wsAndComments,
		_Bogdanp$elm_combine$Combine$string(k));
};
var _tunguski$elm_ast$Ast_Helpers$commaSeparated = function (p) {
	return A2(
		_Bogdanp$elm_combine$Combine$sepBy1,
		_Bogdanp$elm_combine$Combine$string(','),
		A2(_tunguski$elm_ast$Ast_Helpers$between_, _tunguski$elm_ast$Ast_Helpers$wsAndComments, p));
};
var _tunguski$elm_ast$Ast_Helpers$commaSeparated_ = function (p) {
	return A2(
		_Bogdanp$elm_combine$Combine$sepBy,
		_Bogdanp$elm_combine$Combine$string(','),
		A2(_tunguski$elm_ast$Ast_Helpers$between_, _tunguski$elm_ast$Ast_Helpers$wsAndComments, p));
};
var _tunguski$elm_ast$Ast_Helpers$moduleName = A2(
	_tunguski$elm_ast$Ast_Helpers$between_,
	_tunguski$elm_ast$Ast_Helpers$spaces,
	A2(
		_Bogdanp$elm_combine$Combine$sepBy1,
...
var _tunguski$elm_ast$Ast_Helpers$reservedOperators = {
	ctor: '::',
	_0: '=',
	_1: {
		ctor: '::',
...
var _tunguski$elm_ast$Ast_Helpers$operator = A2(
	_Bogdanp$elm_combine$Combine$andThen,
	function (n) {
		return A2(_elm_lang$core$List$member, n, _tunguski$elm_ast$Ast_Helpers$reservedOperators) ? _Bogdanp$elm_combine$Combine$fail(
			A2(
				_elm_lang$core$Basics_ops['++'],
				'operator \'',
	...
	_Bogdanp$elm_combine$Combine$regex('[+-/*=.$<>:&|^?%#@~!]+'));
var _tunguski$elm_ast$Ast_Helpers$operatorReference = _Bogdanp$elm_combine$Combine$parens(_tunguski$elm_ast$Ast_Helpers$operator);
var _tunguski$elm_ast$Ast_Helpers$reserved = {
	ctor: '::',
	_0: 'module',
	_1: {
		ctor: '::',
...
var _tunguski$elm_ast$Ast_Helpers$loName = function () {
	var loName_ = A2(
		_Bogdanp$elm_combine$Combine$andThen,
		function (n) {
			return A2(_elm_lang$core$List$member, n, _tunguski$elm_ast$Ast_Helpers$reserved) ? _Bogdanp$elm_combine$Combine$fail(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'name \'',
					A2(_elm_lang$core$Basics_ops['++'], n, '\' is reserved'))) : _Bogdanp$elm_combine$Combine$succeed(n);
		},
		_tunguski$elm_ast$Ast_Helpers$name(_Bogdanp$elm_combine$Combine_Char$lower));
	return A2(
		_Bogdanp$elm_combine$Combine_ops['<|>'],
		_Bogdanp$elm_combine$Combine$string('_'),
		loName_);
}();
var _tunguski$elm_ast$Ast_Helpers$functionName = _tunguski$elm_ast$Ast_Helpers$loName;
var _tunguski$elm_ast$Ast_Helpers$functionOrOperator = _Bogdanp$elm_combine$Combine$choice(
	{
		ctor: '::',
		_0: _tunguski$elm_ast$Ast_Helpers$functionName,
		_1: {
			ctor: '::',
			_0: _tunguski$elm_ast$Ast_Helpers$operatorReference,
			_1: {ctor: '[]'}
		}
	});

var _tunguski$elm_ast$Ast_BinOp$R = {ctor: 'R'};
var _tunguski$elm_ast$Ast_BinOp$L = {ctor: 'L'};
var _tunguski$elm_ast$Ast_BinOp$operators = A3(
	_elm_lang$core$Dict$insert,
	'|>',
	{ctor: '_Tuple2', _0: _tunguski$elm_ast$Ast_BinOp$R, _1: 0},
	A3(
		_elm_lang$core$Dict$insert,
		'<|',
		{ctor: '_Tuple2', _0: _tunguski$elm_ast$Ast_BinOp$R, _1: 0},
		A3(
			_elm_lang$core$Dict$insert,
			'>>',
			{ctor: '_Tuple2', _0: _tunguski$elm_ast$Ast_BinOp$L, _1: 9},
			A3(
				_elm_lang$core$Dict$insert,
				'<<',
				{ctor: '_Tuple2', _0: _tunguski$elm_ast$Ast_BinOp$L, _1: 9},
				A3(
					_elm_lang$core$Dict$insert,
					'^',
					{ctor: '_Tuple2', _0: _tunguski$elm_ast$Ast_BinOp$L, _1: 8},
					A3(
						_elm_lang$core$Dict$insert,
						'rem',
						{ctor: '_Tuple2', _0: _tunguski$elm_ast$Ast_BinOp$L, _1: 7},
						A3(
							_elm_lang$core$Dict$insert,
							'//',
							{ctor: '_Tuple2', _0: _tunguski$elm_ast$Ast_BinOp$L, _1: 7},
								...
								A3(
									...
									A3(
										...
										A3(
											_elm_lang$core$Dict$insert,
											'-',
											{ctor: '_Tuple2', _0: _tunguski$elm_ast$Ast_BinOp$L, _1: 6},
											A3(
												_elm_lang$core$Dict$insert,
												'+',
												{ctor: '_Tuple2', _0: _tunguski$elm_ast$Ast_BinOp$L, _1: 6},
												A3(
													_elm_lang$core$Dict$insert,
													'++',
													{ctor: '_Tuple2', _0: _tunguski$elm_ast$Ast_BinOp$L, _1: 5},
													A3(
														_elm_lang$core$Dict$insert,
														'<=',
														{ctor: '_Tuple2', _0: _tunguski$elm_ast$Ast_BinOp$L, _1: 4},
														A3(
															_elm_lang$core$Dict$insert,
															'>=',
															{ctor: '_Tuple2', _0: _tunguski$elm_ast$Ast_BinOp$L, _1: 4},
																	...
																	A3(
																		...
																		A3(
																			...
																			A3(
																				_elm_lang$core$Dict$insert,
																				'&&',
																				{ctor: '_Tuple2', _0: _tunguski$elm_ast$Ast_BinOp$L, _1: 3},
																				A3(
																					_elm_lang$core$Dict$insert,
																					'||',
																					{ctor: '_Tuple2', _0: _tunguski$elm_ast$Ast_BinOp$L, _1: 2},
																					_elm_lang$core$Dict$empty)))))))))))))))))))));
var _tunguski$elm_ast$Ast_BinOp$N = {ctor: 'N'};

var _tunguski$elm_ast$Ast_Expression$op = F2(
	function (ops, n) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			{ctor: '_Tuple2', _0: _tunguski$elm_ast$Ast_BinOp$L, _1: 9},
...
var _tunguski$elm_ast$Ast_Expression$assoc = F2(
	function (ops, n) {
		return _elm_lang$core$Tuple$first(
			A2(_tunguski$elm_ast$Ast_Expression$op, ops, n));
	});
var _tunguski$elm_ast$Ast_Expression$level = F2(
	function (ops, n) {
		return _elm_lang$core$Tuple$second(
			A2(_tunguski$elm_ast$Ast_Expression$op, ops, n));
	});
var _tunguski$elm_ast$Ast_Expression$hasLevel = F3(
	function (ops, l, _p0) {
		var _p1 = _p0;
		return _elm_lang$core$Native_Utils.eq(
			A2(_tunguski$elm_ast$Ast_Expression$level, ops, _p1._0),
			l);
	});
var _tunguski$elm_ast$Ast_Expression$findAssoc = F3(
	function (ops, l, eops) {
		var lops = A2(
			_elm_lang$core$List$filter,
			A2(_tunguski$elm_ast$Ast_Expression$hasLevel, ops, l),
			eops);
		var assocs = A2(
			_elm_lang$core$List$map,
			function (_p2) {
				return A2(
					_tunguski$elm_ast$Ast_Expression$assoc,
					ops,
		...
		if (A2(
			...
			F2(
				function (x, y) {
					return _elm_lang$core$Native_Utils.eq(x, y);
				})(_tunguski$elm_ast$Ast_BinOp$L),
			assocs)) {
			return _Bogdanp$elm_combine$Combine$succeed(_tunguski$elm_ast$Ast_BinOp$L);
		} else {
			if (A2(
				_elm_lang$core$List$all,
				F2(
					function (x, y) {
						return _elm_lang$core$Native_Utils.eq(x, y);
					})(_tunguski$elm_ast$Ast_BinOp$R),
				assocs)) {
				return _Bogdanp$elm_combine$Combine$succeed(_tunguski$elm_ast$Ast_BinOp$R);
			} else {
				if (A2(
					_elm_lang$core$List$all,
					F2(
						function (x, y) {
							return _elm_lang$core$Native_Utils.eq(x, y);
						})(_tunguski$elm_ast$Ast_BinOp$N),
					assocs)) {
					var _p3 = assocs;
					if ((_p3.ctor === '::') && (_p3._1.ctor === '[]')) {
						return _Bogdanp$elm_combine$Combine$succeed(_tunguski$elm_ast$Ast_BinOp$N);
					} else {
...
var _tunguski$elm_ast$Ast_Expression$named = F2(
	function (value, expr) {
		return _Bogdanp$elm_combine$Combine$choice(
			{
				...
				_1: {
					ctor: '::',
					_0: _Bogdanp$elm_combine$Combine$succeed(expr),
					_1: {ctor: '[]'}
				}
			});
	});
...
var _tunguski$elm_ast$Ast_Expression$Cont = function (a) {
	return {ctor: 'Cont', _0: a};
};
var _tunguski$elm_ast$Ast_Expression$NamedExpression = F2(
	function (a, b) {
		return {ctor: 'NamedExpression', _0: a, _1: b};
	});
var _tunguski$elm_ast$Ast_Expression$BinOp = F3(
	function (a, b, c) {
		return {ctor: 'BinOp', _0: a, _1: b, _2: c};
	});
var _tunguski$elm_ast$Ast_Expression$Application = F2(
	function (a, b) {
		return {ctor: 'Application', _0: a, _1: b};
	});
var _tunguski$elm_ast$Ast_Expression$Lambda = F2(
	function (a, b) {
		return {ctor: 'Lambda', _0: a, _1: b};
	});
var _tunguski$elm_ast$Ast_Expression$Case = F2(
	function (a, b) {
		return {ctor: 'Case', _0: a, _1: b};
	});
var _tunguski$elm_ast$Ast_Expression$Let = F2(
	function (a, b) {
		return {ctor: 'Let', _0: a, _1: b};
	});
var _tunguski$elm_ast$Ast_Expression$If = F3(
	function (a, b, c) {
		return {ctor: 'If', _0: a, _1: b, _2: c};
	});
var _tunguski$elm_ast$Ast_Expression$RecordUpdate = F2(
	function (a, b) {
		return {ctor: 'RecordUpdate', _0: a, _1: b};
	});
var _tunguski$elm_ast$Ast_Expression$Record = function (a) {
	return {ctor: 'Record', _0: a};
};
var _tunguski$elm_ast$Ast_Expression$Access = F2(
	function (a, b) {
		return {ctor: 'Access', _0: a, _1: b};
	});
var _tunguski$elm_ast$Ast_Expression$List = function (a) {
	return {ctor: 'List', _0: a};
};
var _tunguski$elm_ast$Ast_Expression$OperatorReference = function (a) {
	return {ctor: 'OperatorReference', _0: a};
};
...
var _tunguski$elm_ast$Ast_Expression$variable = A2(
	_Bogdanp$elm_combine$Combine_ops['<$>'],
	_tunguski$elm_ast$Ast_Expression$Variable,
	_Bogdanp$elm_combine$Combine$choice(
		{
			ctor: '::',
			_0: A2(_Bogdanp$elm_combine$Combine_ops['<$>'], _elm_lang$core$List$singleton, _tunguski$elm_ast$Ast_Helpers$loName),
			_1: {
				ctor: '::',
				_0: A2(
					_Bogdanp$elm_combine$Combine$sepBy1,
...
var _tunguski$elm_ast$Ast_Expression$access = A2(
	_Bogdanp$elm_combine$Combine_ops['<*>'],
	A2(_Bogdanp$elm_combine$Combine_ops['<$>'], _tunguski$elm_ast$Ast_Expression$Access, _tunguski$elm_ast$Ast_Expression$variable),
	_Bogdanp$elm_combine$Combine$many1(
		A2(
			_Bogdanp$elm_combine$Combine_ops['*>'],
			_Bogdanp$elm_combine$Combine$string('.'),
			_tunguski$elm_ast$Ast_Helpers$loName)));
var _tunguski$elm_ast$Ast_Expression$simplifiedRecord = _Bogdanp$elm_combine$Combine$lazy(
	function (_p4) {
		var _p5 = _p4;
		return A2(
			_Bogdanp$elm_combine$Combine_ops['<$>'],
					...
					A2(
						...
						function (a) {
							return {
								ctor: '_Tuple2',
								_0: a,
								_1: _tunguski$elm_ast$Ast_Expression$Variable(
									{
										ctor: '::',
										_0: a,
										_1: {ctor: '[]'}
...
var _tunguski$elm_ast$Ast_Expression$joinL = F2(
	function (es, ops) {
		joinL:
		while (true) {
			...
			do {
				if ((_p6.ctor === '_Tuple2') && (_p6._0.ctor === '::')) {
					if (_p6._0._1.ctor === '[]') {
						if (_p6._1.ctor === '[]') {
							return _Bogdanp$elm_combine$Combine$succeed(_p6._0._0);
						} else {
							break _v3_2;
						}
					} else {
						if (_p6._1.ctor === '::') {
							var _v4 = {
								ctor: '::',
								_0: A3(
									_tunguski$elm_ast$Ast_Expression$BinOp,
									_tunguski$elm_ast$Ast_Expression$Variable(
										{
											ctor: '::',
											_0: _p6._1._0,
...
var _tunguski$elm_ast$Ast_Expression$joinR = F2(
	function (es, ops) {
		...
		do {
			if ((_p7.ctor === '_Tuple2') && (_p7._0.ctor === '::')) {
				if (_p7._0._1.ctor === '[]') {
					if (_p7._1.ctor === '[]') {
						return _Bogdanp$elm_combine$Combine$succeed(_p7._0._0);
					} else {
						break _v6_2;
					}
				} else {
					if (_p7._1.ctor === '::') {
						return A2(
							...
							A2(
								_tunguski$elm_ast$Ast_Expression$joinR,
...
var _tunguski$elm_ast$Ast_Expression$split = F4(
					...
					return A2(
						...
						function (es) {
							var ops_ = A2(
								_elm_lang$core$List$filterMap,
								function (x) {
									return A3(_tunguski$elm_ast$Ast_Expression$hasLevel, ops, l, x) ? _elm_lang$core$Maybe$Just(
										_elm_lang$core$Tuple$first(x)) : _elm_lang$core$Maybe$Nothing;
								},
								eops);
							var _p9 = assoc;
							if (_p9.ctor === 'R') {
								return A2(_tunguski$elm_ast$Ast_Expression$joinR, es, ops_);
							} else {
								return A2(_tunguski$elm_ast$Ast_Expression$joinL, es, ops_);
							}
						},
						_Bogdanp$elm_combine$Combine$sequence(
							A4(_tunguski$elm_ast$Ast_Expression$splitLevel, ops, l, e, eops)));
				},
				A3(_tunguski$elm_ast$Ast_Expression$findAssoc, ops, l, eops));
		}
	});
var _tunguski$elm_ast$Ast_Expression$splitLevel = F4(
	function (ops, l, e, eops) {
		var _p10 = A2(
		...
		if (_p10._1.ctor === '::') {
			return {
				ctor: '::',
				_0: A4(_tunguski$elm_ast$Ast_Expression$split, ops, l + 1, e, _p10._0),
				_1: A4(_tunguski$elm_ast$Ast_Expression$splitLevel, ops, l, _p10._1._0._1, _p10._1._1)
			};
		} else {
			return {
				ctor: '::',
...
var _tunguski$elm_ast$Ast_Expression$Float = function (a) {
	return {ctor: 'Float', _0: a};
};
var _tunguski$elm_ast$Ast_Expression$float = A2(_Bogdanp$elm_combine$Combine_ops['<$>'], _tunguski$elm_ast$Ast_Expression$Float, _Bogdanp$elm_combine$Combine_Num$float);
var _tunguski$elm_ast$Ast_Expression$Integer = function (a) {
	return {ctor: 'Integer', _0: a};
};
var _tunguski$elm_ast$Ast_Expression$integer = A2(_Bogdanp$elm_combine$Combine_ops['<$>'], _tunguski$elm_ast$Ast_Expression$Integer, _Bogdanp$elm_combine$Combine_Num$int);
var _tunguski$elm_ast$Ast_Expression$String = function (a) {
	return {ctor: 'String', _0: a};
};
var _tunguski$elm_ast$Ast_Expression$string = function () {
	var multiString = A2(
		_Bogdanp$elm_combine$Combine_ops['<$>'],
		function (_p11) {
	...
	var singleString = A2(
		_Bogdanp$elm_combine$Combine_ops['<$>'],
		_tunguski$elm_ast$Ast_Expression$String,
		A2(
			_Bogdanp$elm_combine$Combine_ops['<*'],
			A2(
				_Bogdanp$elm_combine$Combine_ops['*>'],
...
var _tunguski$elm_ast$Ast_Expression$Character = function (a) {
	return {ctor: 'Character', _0: a};
};
var _tunguski$elm_ast$Ast_Expression$character = A2(
	_Bogdanp$elm_combine$Combine_ops['<$>'],
	_tunguski$elm_ast$Ast_Expression$Character,
	A2(
		_tunguski$elm_ast$Ast_Helpers$between_,
		_Bogdanp$elm_combine$Combine$string('\''),
		A2(
			...
			A2(
				...
				A2(
					_Bogdanp$elm_combine$Combine_ops['*>'],
					_Bogdanp$elm_combine$Combine$string('\\'),
					_Bogdanp$elm_combine$Combine$regex('(n|t|r|\\\\|x..)')),
				function (a) {
					var _p12 = a;
					switch (_p12) {
						case 'n':
			...
			_Bogdanp$elm_combine$Combine_Char$anyChar)));
var _tunguski$elm_ast$Ast_Expression$TypeExport = F2(
	function (a, b) {
		return {ctor: 'TypeExport', _0: a, _1: b};
	});
var _tunguski$elm_ast$Ast_Expression$FunctionExport = function (a) {
	return {ctor: 'FunctionExport', _0: a};
};
var _tunguski$elm_ast$Ast_Expression$functionExport = A2(_Bogdanp$elm_combine$Combine_ops['<$>'], _tunguski$elm_ast$Ast_Expression$FunctionExport, _tunguski$elm_ast$Ast_Helpers$functionOrOperator);
var _tunguski$elm_ast$Ast_Expression$SubsetExport = function (a) {
	return {ctor: 'SubsetExport', _0: a};
};
var _tunguski$elm_ast$Ast_Expression$constructorSubsetExports = A2(
	_Bogdanp$elm_combine$Combine_ops['<$>'],
	_tunguski$elm_ast$Ast_Expression$SubsetExport,
	_tunguski$elm_ast$Ast_Helpers$commaSeparated(
		A2(_Bogdanp$elm_combine$Combine_ops['<$>'], _tunguski$elm_ast$Ast_Expression$FunctionExport, _tunguski$elm_ast$Ast_Helpers$upName)));
var _tunguski$elm_ast$Ast_Expression$AllExport = {ctor: 'AllExport'};
var _tunguski$elm_ast$Ast_Expression$allExport = A2(
	_Bogdanp$elm_combine$Combine_ops['<$'],
	_tunguski$elm_ast$Ast_Expression$AllExport,
	_tunguski$elm_ast$Ast_Helpers$symbol('..'));
var _tunguski$elm_ast$Ast_Expression$constructorExports = _Bogdanp$elm_combine$Combine$maybe(
	_Bogdanp$elm_combine$Combine$parens(
		_Bogdanp$elm_combine$Combine$choice(
			{
				ctor: '::',
				_0: _tunguski$elm_ast$Ast_Expression$allExport,
				_1: {
					ctor: '::',
					_0: _tunguski$elm_ast$Ast_Expression$constructorSubsetExports,
					_1: {ctor: '[]'}
				}
			})));
var _tunguski$elm_ast$Ast_Expression$typeExport = A2(
	_Bogdanp$elm_combine$Combine_ops['<*>'],
	A2(
		_Bogdanp$elm_combine$Combine_ops['<$>'],
		_tunguski$elm_ast$Ast_Expression$TypeExport,
		A2(_Bogdanp$elm_combine$Combine_ops['<*'], _tunguski$elm_ast$Ast_Helpers$upName, _tunguski$elm_ast$Ast_Helpers$spaces)),
	_tunguski$elm_ast$Ast_Expression$constructorExports);
var _tunguski$elm_ast$Ast_Expression$subsetExport = A2(
	_Bogdanp$elm_combine$Combine_ops['<$>'],
	_tunguski$elm_ast$Ast_Expression$SubsetExport,
	_tunguski$elm_ast$Ast_Helpers$commaSeparated(
		A2(_Bogdanp$elm_combine$Combine$or, _tunguski$elm_ast$Ast_Expression$typeExport, _tunguski$elm_ast$Ast_Expression$functionExport)));
var _tunguski$elm_ast$Ast_Expression$exports = _Bogdanp$elm_combine$Combine$parens(
	_Bogdanp$elm_combine$Combine$choice(
		{
			ctor: '::',
			_0: _tunguski$elm_ast$Ast_Expression$allExport,
			_1: {
				ctor: '::',
				_0: _tunguski$elm_ast$Ast_Expression$subsetExport,
				_1: {ctor: '[]'}
			}
		}));
var _tunguski$elm_ast$Ast_Expression$NamedType = F2(
	function (a, b) {
		return {ctor: 'NamedType', _0: a, _1: b};
	});
var _tunguski$elm_ast$Ast_Expression$TypeApplication = F2(
	function (a, b) {
		return {ctor: 'TypeApplication', _0: a, _1: b};
	});
var _tunguski$elm_ast$Ast_Expression$typeApplication = A2(
	_Bogdanp$elm_combine$Combine_ops['<$'],
	_tunguski$elm_ast$Ast_Expression$TypeApplication,
	_tunguski$elm_ast$Ast_Helpers$symbol('->'));
var _tunguski$elm_ast$Ast_Expression$TypeTuple = function (a) {
	return {ctor: 'TypeTuple', _0: a};
};
var _tunguski$elm_ast$Ast_Expression$TypeRecord = function (a) {
	return {ctor: 'TypeRecord', _0: a};
};
var _tunguski$elm_ast$Ast_Expression$TypeRecordConstructor = F2(
	function (a, b) {
		return {ctor: 'TypeRecordConstructor', _0: a, _1: b};
	});
var _tunguski$elm_ast$Ast_Expression$TypeVariable = function (a) {
	return {ctor: 'TypeVariable', _0: a};
};
var _tunguski$elm_ast$Ast_Expression$typeVariable = A2(_Bogdanp$elm_combine$Combine_ops['<$>'], _tunguski$elm_ast$Ast_Expression$TypeVariable, _tunguski$elm_ast$Ast_Helpers$loName);
var _tunguski$elm_ast$Ast_Expression$TypeConstructor = F2(
	function (a, b) {
		return {ctor: 'TypeConstructor', _0: a, _1: b};
	});
var _tunguski$elm_ast$Ast_Expression$typeConstant = A2(
	_Bogdanp$elm_combine$Combine_ops['<*>'],
	A2(
		_Bogdanp$elm_combine$Combine_ops['<$>'],
		_tunguski$elm_ast$Ast_Expression$TypeConstructor,
		A2(
			_Bogdanp$elm_combine$Combine$sepBy1,
			_Bogdanp$elm_combine$Combine$string('.'),
			_tunguski$elm_ast$Ast_Helpers$upName)),
	_Bogdanp$elm_combine$Combine$succeed(
		{ctor: '[]'}));
var _tunguski$elm_ast$Ast_Expression$typeConstructor = _Bogdanp$elm_combine$Combine$lazy(
	function (_p13) {
		var _p14 = _p13;
					...
					_Bogdanp$elm_combine$Combine$many(
						A2(
							...
							function (isIndented) {
								var _p15 = isIndented;
								if (_p15 === true) {
									return A2(_Bogdanp$elm_combine$Combine_ops['*>'], _tunguski$elm_ast$Ast_Helpers$wsAndComments, _tunguski$elm_ast$Ast_Expression$type_);
								} else {
									return A2(_Bogdanp$elm_combine$Combine_ops['*>'], _tunguski$elm_ast$Ast_Helpers$spaces_, _tunguski$elm_ast$Ast_Expression$type_);
								}
							},
												...
												return {
													...
													_2: _elm_lang$core$Result$Ok(
														_elm_lang$core$Native_Utils.cmp(
															location.column,
															_Bogdanp$elm_combine$Combine$currentLocation(inputStream).column) < 1)
												};
											})))))));
			});
	});
var _tunguski$elm_ast$Ast_Expression$type_ = _Bogdanp$elm_combine$Combine$lazy(
	function (_p16) {
		var _p17 = _p16;
		return A2(
			_tunguski$elm_ast$Ast_Helpers$between_,
			...
			_Bogdanp$elm_combine$Combine$choice(
				{
					ctor: '::',
					_0: _tunguski$elm_ast$Ast_Expression$typeConstructor,
					_1: {
						ctor: '::',
						_0: _tunguski$elm_ast$Ast_Expression$typeVariable,
						_1: {
							ctor: '::',
							_0: _tunguski$elm_ast$Ast_Expression$typeRecordConstructor,
							_1: {
								ctor: '::',
								_0: _tunguski$elm_ast$Ast_Expression$typeRecord,
								_1: {
									ctor: '::',
									_0: _tunguski$elm_ast$Ast_Expression$typeTuple,
									_1: {
										ctor: '::',
										_0: _Bogdanp$elm_combine$Combine$parens(_tunguski$elm_ast$Ast_Expression$typeAnnotation),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _tunguski$elm_ast$Ast_Expression$typeAnnotation = _Bogdanp$elm_combine$Combine$lazy(
	function (_p18) {
		var _p19 = _p18;
		return A2(_Bogdanp$elm_combine$Combine$chainr, _tunguski$elm_ast$Ast_Expression$typeApplication, _tunguski$elm_ast$Ast_Expression$type_);
	});
var _tunguski$elm_ast$Ast_Expression$typeRecord = _Bogdanp$elm_combine$Combine$lazy(
	function (_p20) {
		var _p21 = _p20;
		return _Bogdanp$elm_combine$Combine$braces(
			A2(_Bogdanp$elm_combine$Combine_ops['<$>'], _tunguski$elm_ast$Ast_Expression$TypeRecord, _tunguski$elm_ast$Ast_Expression$typeRecordPairs));
	});
var _tunguski$elm_ast$Ast_Expression$typeRecordPairs = _Bogdanp$elm_combine$Combine$lazy(
	function (_p22) {
		var _p23 = _p22;
		return _tunguski$elm_ast$Ast_Helpers$commaSeparated_(_tunguski$elm_ast$Ast_Expression$typeRecordPair);
	});
var _tunguski$elm_ast$Ast_Expression$typeRecordPair = _Bogdanp$elm_combine$Combine$lazy(
	function (_p24) {
		var _p25 = _p24;
		return A2(
			_Bogdanp$elm_combine$Combine_ops['<*>'],
			A2(
				...
				A2(
					...
					_tunguski$elm_ast$Ast_Helpers$loName,
					_tunguski$elm_ast$Ast_Helpers$symbol(':'))),
			_tunguski$elm_ast$Ast_Expression$typeAnnotation);
	});
var _tunguski$elm_ast$Ast_Expression$typeRecordConstructor = _Bogdanp$elm_combine$Combine$lazy(
	function (_p26) {
		var _p27 = _p26;
		return _Bogdanp$elm_combine$Combine$braces(
			A2(
				...
				A2(
					_Bogdanp$elm_combine$Combine_ops['<$>'],
					_tunguski$elm_ast$Ast_Expression$TypeRecordConstructor,
					A2(_tunguski$elm_ast$Ast_Helpers$between_, _tunguski$elm_ast$Ast_Helpers$spaces, _tunguski$elm_ast$Ast_Expression$typeVariable)),
				A2(
					_Bogdanp$elm_combine$Combine_ops['*>'],
					_tunguski$elm_ast$Ast_Helpers$symbol('|'),
					_tunguski$elm_ast$Ast_Expression$typeRecordPairs)));
	});
var _tunguski$elm_ast$Ast_Expression$typeTuple = _Bogdanp$elm_combine$Combine$lazy(
	function (_p28) {
		var _p29 = _p28;
		return A2(
			_Bogdanp$elm_combine$Combine_ops['<$>'],
			_tunguski$elm_ast$Ast_Expression$TypeTuple,
			_Bogdanp$elm_combine$Combine$parens(
				_tunguski$elm_ast$Ast_Helpers$commaSeparated_(_tunguski$elm_ast$Ast_Expression$type_)));
	});
var _tunguski$elm_ast$Ast_Expression$NamedParam = F2(
	function (a, b) {
		return {ctor: 'NamedParam', _0: a, _1: b};
	});
...
var _tunguski$elm_ast$Ast_Expression$accessFunction = A2(
	_Bogdanp$elm_combine$Combine$andThen,
	function (name) {
		return _Bogdanp$elm_combine$Combine$succeed(
			A2(
				...
				{
					ctor: '::',
					_0: _tunguski$elm_ast$Ast_Expression$RefParam('accessedRecord'),
					_1: {ctor: '[]'}
				},
				A2(
					_tunguski$elm_ast$Ast_Expression$Access,
					_tunguski$elm_ast$Ast_Expression$Variable(
						{
							ctor: '::',
							_0: 'accessedRecord',
	...
	A2(
		...
		_Bogdanp$elm_combine$Combine$string('.'),
		_tunguski$elm_ast$Ast_Helpers$loName));
var _tunguski$elm_ast$Ast_Expression$functionParameter = function (ops) {
	return _Bogdanp$elm_combine$Combine$lazy(
		function (_p30) {
			return A2(
				_Bogdanp$elm_combine$Combine_ops['>>='],
				_Bogdanp$elm_combine$Combine$choice(
					{
						ctor: '::',
						_0: A2(_Bogdanp$elm_combine$Combine_ops['<$>'], _tunguski$elm_ast$Ast_Expression$RefParam, _tunguski$elm_ast$Ast_Helpers$loName),
						_1: {
							ctor: '::',
							_0: A2(
								_Bogdanp$elm_combine$Combine_ops['<*>'],
				...
				_tunguski$elm_ast$Ast_Expression$named(_tunguski$elm_ast$Ast_Expression$NamedParam));
		});
};
								...
								_Bogdanp$elm_combine$Combine$choice(
									{
										...
										_1: {
											...
											_0: A2(
												...
												A2(
													_Bogdanp$elm_combine$Combine_ops['<$>'],
													_tunguski$elm_ast$Ast_Expression$DestructuringBinding,
													_tunguski$elm_ast$Ast_Expression$functionParameter(ops)),
												A2(
													_Bogdanp$elm_combine$Combine_ops['*>'],
													_tunguski$elm_ast$Ast_Helpers$symbol('='),
	...
	return _Bogdanp$elm_combine$Combine$lazy(
		function (_p35) {
			...
			var next = A2(
							...
							if (_p37.ctor === 'Cont') {
								return A2(
									...
									F2(
										...
										{ctor: '_Tuple2', _0: op, _1: _p37._0}),
									collect);
							} else {
								return _Bogdanp$elm_combine$Combine$succeed(
									{
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: op, _1: _p37._0},
										_1: {ctor: '[]'}
									});
							}
						},
				...
				A2(_tunguski$elm_ast$Ast_Helpers$between_, _tunguski$elm_ast$Ast_Helpers$wsAndComments, _tunguski$elm_ast$Ast_Helpers$operator));
			var collect = A2(
				_Bogdanp$elm_combine$Combine_ops['<|>'],
				next,
				_Bogdanp$elm_combine$Combine$succeed(
...
var _tunguski$elm_ast$Ast_Expression$application = function (ops) {
	return _Bogdanp$elm_combine$Combine$lazy(
		function (_p38) {
			...
			return A2(
				_Bogdanp$elm_combine$Combine_ops['>>='],
				_Bogdanp$elm_combine$Combine$withLocation(
					function (location) {
						return A2(
							...
							A2(
								...
								A2(
									...
									function (isIndented) {
										var _p40 = isIndented;
										if (_p40 === true) {
											return _tunguski$elm_ast$Ast_Helpers$wsAndComments;
										} else {
				...
				_tunguski$elm_ast$Ast_Expression$named(_tunguski$elm_ast$Ast_Expression$NamedExpression));
		});
};
						...
						_1: {
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _tunguski$elm_ast$Ast_Expression$accessFunction,
										_1: {
											ctor: '::',
											_0: _tunguski$elm_ast$Ast_Expression$variable,
											_1: {
												ctor: '::',
												_0: A2(_Bogdanp$elm_combine$Combine_ops['<$>'], _tunguski$elm_ast$Ast_Expression$OperatorReference, _tunguski$elm_ast$Ast_Helpers$operatorReference),
												_1: {
													ctor: '::',
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _tunguski$elm_ast$Ast_Expression$simplifiedRecord,
															_1: {
																ctor: '::',
																_0: _tunguski$elm_ast$Ast_Expression$recordUpdate(ops),
																_1: {
																	ctor: '::',
																	...
																	_1: {
																		ctor: '::',
																		_0: _tunguski$elm_ast$Ast_Expression$tuple(ops),
																		_1: {
																			ctor: '::',
																			_0: A2(
																				_Bogdanp$elm_combine$Combine$map,
...
var _tunguski$elm_ast$Ast_Expression$recordUpdate = function (ops) {
	return _Bogdanp$elm_combine$Combine$lazy(
		function (_p47) {
			var _p48 = _p47;
			return A2(
				...
				_Bogdanp$elm_combine$Combine$braces(
					A2(
						...
						A2(
							_Bogdanp$elm_combine$Combine_ops['<$>'],
							_tunguski$elm_ast$Ast_Expression$RecordUpdate,
							A2(_Bogdanp$elm_combine$Combine_ops['*>'], _tunguski$elm_ast$Ast_Helpers$wsAndComments, _tunguski$elm_ast$Ast_Helpers$loName)),
						A2(
							_Bogdanp$elm_combine$Combine_ops['*>'],
							_tunguski$elm_ast$Ast_Helpers$symbol('|'),
							_tunguski$elm_ast$Ast_Helpers$commaSeparated_(
...
var _tunguski$elm_ast$Ast_Expression$tuple = function (ops) {
	return _Bogdanp$elm_combine$Combine$lazy(
		function (_p49) {
			return A2(
				_Bogdanp$elm_combine$Combine_ops['<$>'],
				_tunguski$elm_ast$Ast_Expression$TupleExpr,
				_Bogdanp$elm_combine$Combine$parens(
					_tunguski$elm_ast$Ast_Helpers$commaSeparated_(
						_tunguski$elm_ast$Ast_Expression$expression(ops))));
		});
						...
						_Bogdanp$elm_combine$Combine$many(
							A2(
								...
								function (isIndented) {
									var _p54 = isIndented;
									if (_p54 === true) {
										return A2(_Bogdanp$elm_combine$Combine_ops['*>'], _tunguski$elm_ast$Ast_Helpers$wsAndComments, binding);
									} else {
										return A2(_Bogdanp$elm_combine$Combine_ops['*>'], _tunguski$elm_ast$Ast_Helpers$spaces_, binding);
									}
								},
								_Bogdanp$elm_combine$Combine$lookAhead(
									A2(
...
var _tunguski$elm_ast$Ast_Expression$comment = A2(_Bogdanp$elm_combine$Combine_ops['<$>'], _tunguski$elm_ast$Ast_Expression$Comment, _tunguski$elm_ast$Ast_Helpers$comments);
var _tunguski$elm_ast$Ast_Expression$InfixDeclaration = F3(
	function (a, b, c) {
		return {ctor: 'InfixDeclaration', _0: a, _1: b, _2: c};
	});
var _tunguski$elm_ast$Ast_Expression$infixDeclaration = A2(
	_Bogdanp$elm_combine$Combine_ops['<*>'],
	A2(
		_Bogdanp$elm_combine$Combine_ops['<*>'],
		A2(
			_Bogdanp$elm_combine$Combine_ops['<$>'],
			_tunguski$elm_ast$Ast_Expression$InfixDeclaration,
			_Bogdanp$elm_combine$Combine$choice(
				{
					ctor: '::',
					_0: A2(
						_Bogdanp$elm_combine$Combine_ops['<$'],
						_tunguski$elm_ast$Ast_BinOp$L,
						_tunguski$elm_ast$Ast_Helpers$initialSymbol('infixl')),
					_1: {
						ctor: '::',
						_0: A2(
							_Bogdanp$elm_combine$Combine_ops['<$'],
							_tunguski$elm_ast$Ast_BinOp$R,
							_tunguski$elm_ast$Ast_Helpers$initialSymbol('infixr')),
						_1: {
							ctor: '::',
							_0: A2(
								_Bogdanp$elm_combine$Combine_ops['<$'],
								_tunguski$elm_ast$Ast_BinOp$N,
								_tunguski$elm_ast$Ast_Helpers$initialSymbol('infix')),
							_1: {ctor: '[]'}
						}
					}
				})),
		A2(_Bogdanp$elm_combine$Combine_ops['*>'], _tunguski$elm_ast$Ast_Helpers$spaces, _Bogdanp$elm_combine$Combine_Num$int)),
	A2(
		_Bogdanp$elm_combine$Combine_ops['*>'],
		_tunguski$elm_ast$Ast_Helpers$spaces,
		A2(_Bogdanp$elm_combine$Combine_ops['<|>'], _tunguski$elm_ast$Ast_Helpers$loName, _tunguski$elm_ast$Ast_Helpers$operator)));
var _tunguski$elm_ast$Ast_Expression$infixStatements = function () {
	var statements = A2(
		_Bogdanp$elm_combine$Combine_ops['<*'],
		_Bogdanp$elm_combine$Combine$many(
			A2(
				...
				_Bogdanp$elm_combine$Combine$choice(
					{
						ctor: '::',
						_0: A2(_Bogdanp$elm_combine$Combine_ops['<$>'], _elm_lang$core$Maybe$Just, _tunguski$elm_ast$Ast_Expression$infixDeclaration),
						_1: {
							ctor: '::',
							_0: A2(
								_Bogdanp$elm_combine$Combine_ops['<$'],
...
var _tunguski$elm_ast$Ast_Expression$opTable = function (ops) {
	var collect = F2(
		function (s, d) {
			var _p59 = s;
			if (_p59.ctor === 'InfixDeclaration') {
				return A3(
					_elm_lang$core$Dict$insert,
					_p59._2,
					{ctor: '_Tuple2', _0: _p59._0, _1: _p59._1},
					d);
			} else {
				return _elm_lang$core$Native_Utils.crashCase(
					'Ast.Expression',
					{
						start: {line: 751, column: 7},
						end: {line: 756, column: 35}
					},
					_p59)('impossible');
			}
		});
...
var _tunguski$elm_ast$Ast_Expression$functionTypeDeclaration = A2(
	_Bogdanp$elm_combine$Combine_ops['<*>'],
	A2(
		_Bogdanp$elm_combine$Combine_ops['<$>'],
		_tunguski$elm_ast$Ast_Expression$FunctionTypeDeclaration,
		A2(
			_Bogdanp$elm_combine$Combine_ops['<*'],
			_tunguski$elm_ast$Ast_Helpers$functionOrOperator,
			_tunguski$elm_ast$Ast_Helpers$symbol(':'))),
	_tunguski$elm_ast$Ast_Expression$typeAnnotation);
var _tunguski$elm_ast$Ast_Expression$PortDeclaration = F3(
	function (a, b, c) {
		return {ctor: 'PortDeclaration', _0: a, _1: b, _2: c};
	});
var _tunguski$elm_ast$Ast_Expression$portDeclaration = function (ops) {
	return A2(
		_Bogdanp$elm_combine$Combine_ops['<*>'],
		A2(
			_Bogdanp$elm_combine$Combine_ops['<*>'],
			A2(
				_Bogdanp$elm_combine$Combine_ops['<$>'],
				_tunguski$elm_ast$Ast_Expression$PortDeclaration,
				A2(
					_Bogdanp$elm_combine$Combine_ops['*>'],
					_tunguski$elm_ast$Ast_Helpers$initialSymbol('port'),
					_tunguski$elm_ast$Ast_Helpers$loName)),
			_Bogdanp$elm_combine$Combine$many(
...
var _tunguski$elm_ast$Ast_Expression$PortTypeDeclaration = F2(
	function (a, b) {
		return {ctor: 'PortTypeDeclaration', _0: a, _1: b};
	});
var _tunguski$elm_ast$Ast_Expression$portTypeDeclaration = A2(
	_Bogdanp$elm_combine$Combine_ops['<*>'],
	A2(
		_Bogdanp$elm_combine$Combine_ops['<$>'],
		_tunguski$elm_ast$Ast_Expression$PortTypeDeclaration,
		A2(
			_Bogdanp$elm_combine$Combine_ops['*>'],
			_tunguski$elm_ast$Ast_Helpers$initialSymbol('port'),
			_tunguski$elm_ast$Ast_Helpers$loName)),
	A2(
		...
		_tunguski$elm_ast$Ast_Helpers$symbol(':'),
		_tunguski$elm_ast$Ast_Expression$typeAnnotation));
var _tunguski$elm_ast$Ast_Expression$TypeDeclaration = F2(
	function (a, b) {
		return {ctor: 'TypeDeclaration', _0: a, _1: b};
	});
var _tunguski$elm_ast$Ast_Expression$typeDeclaration = A2(
	_Bogdanp$elm_combine$Combine_ops['<*>'],
	A2(
		_Bogdanp$elm_combine$Combine_ops['<$>'],
		_tunguski$elm_ast$Ast_Expression$TypeDeclaration,
		A2(
			_Bogdanp$elm_combine$Combine_ops['*>'],
			_tunguski$elm_ast$Ast_Helpers$initialSymbol('type'),
			_tunguski$elm_ast$Ast_Expression$type_)),
	A2(
		_Bogdanp$elm_combine$Combine_ops['*>'],
		A2(
			_Bogdanp$elm_combine$Combine_ops['*>'],
		...
		A2(
			_Bogdanp$elm_combine$Combine$sepBy1,
			_tunguski$elm_ast$Ast_Helpers$symbol('|'),
			A2(_tunguski$elm_ast$Ast_Helpers$between_, _tunguski$elm_ast$Ast_Helpers$wsAndComments, _tunguski$elm_ast$Ast_Expression$typeConstructor))));
var _tunguski$elm_ast$Ast_Expression$TypeAliasDeclaration = F2(
	function (a, b) {
		return {ctor: 'TypeAliasDeclaration', _0: a, _1: b};
	});
var _tunguski$elm_ast$Ast_Expression$typeAliasDeclaration = A2(
	_Bogdanp$elm_combine$Combine_ops['<*>'],
	A2(
		_Bogdanp$elm_combine$Combine_ops['<$>'],
		_tunguski$elm_ast$Ast_Expression$TypeAliasDeclaration,
		A2(
			_Bogdanp$elm_combine$Combine_ops['*>'],
			A2(
				_Bogdanp$elm_combine$Combine_ops['*>'],
				_tunguski$elm_ast$Ast_Helpers$initialSymbol('type'),
				_tunguski$elm_ast$Ast_Helpers$symbol('alias')),
			_tunguski$elm_ast$Ast_Expression$type_)),
	A2(
		_Bogdanp$elm_combine$Combine_ops['*>'],
		A2(
			...
			_tunguski$elm_ast$Ast_Helpers$symbol('=')),
		_tunguski$elm_ast$Ast_Expression$typeAnnotation));
var _tunguski$elm_ast$Ast_Expression$ImportStatement = F3(
	function (a, b, c) {
		return {ctor: 'ImportStatement', _0: a, _1: b, _2: c};
	});
var _tunguski$elm_ast$Ast_Expression$importStatement = A2(
	_Bogdanp$elm_combine$Combine_ops['<*>'],
	A2(
		_Bogdanp$elm_combine$Combine_ops['<*>'],
		A2(
			_Bogdanp$elm_combine$Combine_ops['<$>'],
			_tunguski$elm_ast$Ast_Expression$ImportStatement,
			A2(
				_Bogdanp$elm_combine$Combine_ops['*>'],
				_tunguski$elm_ast$Ast_Helpers$initialSymbol('import'),
				_tunguski$elm_ast$Ast_Helpers$moduleName)),
		_Bogdanp$elm_combine$Combine$maybe(
			A2(
				_Bogdanp$elm_combine$Combine_ops['*>'],
				_tunguski$elm_ast$Ast_Helpers$symbol('as'),
				_tunguski$elm_ast$Ast_Helpers$upName))),
	_Bogdanp$elm_combine$Combine$maybe(
		A2(
			_Bogdanp$elm_combine$Combine_ops['*>'],
			_tunguski$elm_ast$Ast_Helpers$symbol('exposing'),
			_tunguski$elm_ast$Ast_Expression$exports)));
var _tunguski$elm_ast$Ast_Expression$EffectsModuleDeclaration = F3(
	function (a, b, c) {
		return {ctor: 'EffectsModuleDeclaration', _0: a, _1: b, _2: c};
	});
var _tunguski$elm_ast$Ast_Expression$effectsModuleDeclaration = A2(
	_Bogdanp$elm_combine$Combine_ops['<*>'],
	A2(
		_Bogdanp$elm_combine$Combine_ops['<*>'],
		A2(
			_Bogdanp$elm_combine$Combine_ops['<$>'],
			_tunguski$elm_ast$Ast_Expression$EffectsModuleDeclaration,
			A2(
				_Bogdanp$elm_combine$Combine_ops['*>'],
				A2(
					_Bogdanp$elm_combine$Combine_ops['*>'],
					_tunguski$elm_ast$Ast_Helpers$initialSymbol('effect'),
					_tunguski$elm_ast$Ast_Helpers$symbol('module')),
				_tunguski$elm_ast$Ast_Helpers$moduleName)),
		A2(
			_Bogdanp$elm_combine$Combine_ops['*>'],
			_tunguski$elm_ast$Ast_Helpers$symbol('where'),
			_tunguski$elm_ast$Ast_Expression$record(_tunguski$elm_ast$Ast_BinOp$operators))),
	A2(
		_Bogdanp$elm_combine$Combine_ops['*>'],
		_tunguski$elm_ast$Ast_Helpers$symbol('exposing'),
		_tunguski$elm_ast$Ast_Expression$exports));
var _tunguski$elm_ast$Ast_Expression$ModuleDeclaration = F2(
	function (a, b) {
		return {ctor: 'ModuleDeclaration', _0: a, _1: b};
	});
var _tunguski$elm_ast$Ast_Expression$moduleDeclaration = A2(
	_Bogdanp$elm_combine$Combine_ops['<*>'],
	A2(
		_Bogdanp$elm_combine$Combine_ops['<$>'],
		_tunguski$elm_ast$Ast_Expression$ModuleDeclaration,
		A2(
			_Bogdanp$elm_combine$Combine_ops['*>'],
			_tunguski$elm_ast$Ast_Helpers$initialSymbol('module'),
			_tunguski$elm_ast$Ast_Helpers$moduleName)),
	A2(
		_Bogdanp$elm_combine$Combine_ops['*>'],
		_tunguski$elm_ast$Ast_Helpers$symbol('exposing'),
		_tunguski$elm_ast$Ast_Expression$exports));
var _tunguski$elm_ast$Ast_Expression$statement = function (ops) {
	return _Bogdanp$elm_combine$Combine$choice(
		{
			ctor: '::',
			_0: _tunguski$elm_ast$Ast_Expression$effectsModuleDeclaration,
			_1: {
				ctor: '::',
				_0: _tunguski$elm_ast$Ast_Expression$moduleDeclaration,
				_1: {
					ctor: '::',
					_0: _tunguski$elm_ast$Ast_Expression$importStatement,
					_1: {
						ctor: '::',
						_0: _tunguski$elm_ast$Ast_Expression$typeAliasDeclaration,
						_1: {
							ctor: '::',
							_0: _tunguski$elm_ast$Ast_Expression$typeDeclaration,
							_1: {
								ctor: '::',
								_0: _tunguski$elm_ast$Ast_Expression$portTypeDeclaration,
								_1: {
									ctor: '::',
									_0: _tunguski$elm_ast$Ast_Expression$portDeclaration(ops),
									_1: {
										ctor: '::',
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _tunguski$elm_ast$Ast_Expression$comment,
													_1: {ctor: '[]'}
												}
											}
										}
...
var _tunguski$elm_ast$Ast_Expression$statements = function (ops) {
	return A2(
		_Bogdanp$elm_combine$Combine$manyTill,
		A2(
			_Bogdanp$elm_combine$Combine_ops['<*'],
			A2(
				_Bogdanp$elm_combine$Combine_ops['*>'],
				_tunguski$elm_ast$Ast_Helpers$wsAndComments,
				_tunguski$elm_ast$Ast_Expression$statement(ops)),
			_tunguski$elm_ast$Ast_Helpers$wsAndComments),
		_Bogdanp$elm_combine$Combine$end);
};

var _tunguski$elm_ast$Ast$parseModule = function (ops) {
	return _Bogdanp$elm_combine$Combine$parse(
		_tunguski$elm_ast$Ast_Expression$statements(ops));
};
var _tunguski$elm_ast$Ast$parseOpTable = function (ops) {
	return _Bogdanp$elm_combine$Combine$parse(
		_tunguski$elm_ast$Ast_Expression$opTable(ops));
};
var _tunguski$elm_ast$Ast$parse = function (input) {
	var _p0 = A2(_tunguski$elm_ast$Ast$parseOpTable, _tunguski$elm_ast$Ast_BinOp$operators, input);
	if (_p0.ctor === 'Ok') {
		return A2(_tunguski$elm_ast$Ast$parseModule, _p0._0._2, input);
	} else {
		return _elm_lang$core$Result$Err(_p0._0);
	}
};
var _tunguski$elm_ast$Ast$parseStatement = function (ops) {
	return _Bogdanp$elm_combine$Combine$parse(
		A2(
			_Bogdanp$elm_combine$Combine_ops['<*'],
			_tunguski$elm_ast$Ast_Expression$statement(ops),
...
var _tunguski$elm_ast$Ast$parseExpression = function (ops) {
	return _Bogdanp$elm_combine$Combine$parse(
		A2(
			_Bogdanp$elm_combine$Combine_ops['<*'],
			_tunguski$elm_ast$Ast_Expression$expression(ops),
...
var _tunguski$elm_ast$Main$countItems = F2(
...
var _tunguski$elm_ast$Main$withChild = F2(
...
var _tunguski$elm_ast$Main$expression = function (e) {
	var _p2 = e;
	switch (_p2.ctor) {
		case 'List':
			return A2(
				_tunguski$elm_ast$Main$withChild,
				e,
				A2(_elm_lang$core$List$map, _tunguski$elm_ast$Main$expression, _p2._0));
		case 'Application':
			return A2(
				_tunguski$elm_ast$Main$withChild,
				e,
				{
					ctor: '::',
					_0: _tunguski$elm_ast$Main$expression(_p2._0),
					_1: {
						ctor: '::',
						_0: _tunguski$elm_ast$Main$expression(_p2._1),
						_1: {ctor: '[]'}
					}
				});
		default:
...
var _tunguski$elm_ast$Main$statement = function (s) {
	var _p3 = s;
	if (_p3.ctor === 'FunctionDeclaration') {
		return A2(
			_tunguski$elm_ast$Main$withChild,
			s,
			{
				ctor: '::',
				_0: _tunguski$elm_ast$Main$expression(_p3._0._2),
				_1: {ctor: '[]'}
			});
	} else {
		return A2(
...
var _tunguski$elm_ast$Main$tree = function (ast) {
	var _p4 = ast;
	if ((_p4.ctor === 'Ok') && (_p4._0.ctor === '_Tuple3')) {
		return A2(
			_elm_lang$html$Html$ul,
			{ctor: '[]'},
			A2(_elm_lang$core$List$map, _tunguski$elm_ast$Main$statement, _p4._0._2));
	} else {
		return A2(
			_elm_lang$html$Html$div,
			{
...
var _tunguski$elm_ast$Main$update = F2(
		...
		if (_p5.ctor === 'Replace') {
			...
			return A2(
				...
				A2(
					_elm_lang$core$List$map,
					function ($package) {
						return _elm_lang$core$Native_Utils.eq($package.$package, _p5._0) ? _elm_lang$core$Native_Utils.update(
							$package,
							{
								items: A2(
									_elm_lang$core$List$map,
									function (item) {
										return _elm_lang$core$Native_Utils.eq(item.moduleName, _p5._1) ? _elm_lang$core$Native_Utils.update(
											item,
											{
												text: _elm_lang$core$Maybe$Just(_p6),
												parsed: _elm_lang$core$Maybe$Just(
													_tunguski$elm_ast$Ast$parse(_p6))
											}) : item;
									},
									$package.items)
							}) : $package;
			...
			if (_p7.ctor === 'Ok') {
									...
									items: A2(
										...
										function (item) {
											return _elm_lang$core$Native_Utils.eq(item.moduleName, _p5._1) ? _elm_lang$core$Native_Utils.update(
												item,
												{
													text: _elm_lang$core$Maybe$Just(_p8),
													parsed: _elm_lang$core$Maybe$Just(
														_tunguski$elm_ast$Ast$parse(_p8))
												}) : item;
										},
										$package.items)
								}) : $package;
				...
				var x = A2(_elm_lang$core$Debug$log, 'error', _p7._0);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					{ctor: '[]'});
...
var _tunguski$elm_ast$Main$sampleModule = 'module Main exposing (..)\n\nf : Int -> Int\nf x = x + 1\n\ng : Int -> Int\ng x = x * 2\n\nh = f << g\n\n\nupdate : Msg -> String -> String\nupdate action model =\n    case action of\n        Replace m ->\n            m\n\n\nwithChild : a -> List (Html Msg) -> Html Msg\nwithChild title children =\n    li []\n        [ pre [] [ text <| toString title ]\n        , ul [] children\n        ]\n';
var _tunguski$elm_ast$Main$testFiles = {
	ctor: '::',
	_0: {
		ctor: '_Tuple2',
		_0: 'elm-lang/core/5.1.1/src/',
		_1: {
			ctor: '::',
			_0: 'Array',
			_1: {
	...
	_1: {
		...
		_1: {
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'Bogdanp/elm-combine/3.1.1/src/',
				_1: {
					ctor: '::',
					_0: 'Combine',
					_1: {
...
var _tunguski$elm_ast$Main$Item = F3(
	function (a, b, c) {
		return {moduleName: a, text: b, parsed: c};
	});
var _tunguski$elm_ast$Main$Package = F2(
	function (a, b) {
		return {$package: a, items: b};
	});
var _tunguski$elm_ast$Main$Loaded = F3(
	function (a, b, c) {
		return {ctor: 'Loaded', _0: a, _1: b, _2: c};
	});
var _tunguski$elm_ast$Main$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	{
		ctor: '::',
		_0: A2(
			_tunguski$elm_ast$Main$Package,
			'n/a',
			{
				ctor: '::',
				_0: A3(
					_tunguski$elm_ast$Main$Item,
					'Custom Editor',
					_elm_lang$core$Maybe$Just(_tunguski$elm_ast$Main$sampleModule),
					_elm_lang$core$Maybe$Just(
						_tunguski$elm_ast$Ast$parse(_tunguski$elm_ast$Main$sampleModule))),
				_1: {ctor: '[]'}
			}),
		_1: A2(
			_elm_lang$core$List$map,
			function (_p9) {
				...
				return A2(
					...
					A2(
						_elm_lang$core$List$map,
						function (moduleName) {
							return A3(_tunguski$elm_ast$Main$Item, moduleName, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing);
						},
						_p10._1));
			},
			_tunguski$elm_ast$Main$testFiles)
	},
	A2(
		_elm_lang$core$List$concatMap,
		function (_p11) {
			...
			return A2(
				...
				function (file) {
					return A2(
						...
						A2(_tunguski$elm_ast$Main$Loaded, _p13, file),
						_elm_lang$http$Http$getString(
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									_p13,
									A2(_elm_lang$core$Basics_ops['++'], file, '.elm')))));
				},
				_p12._1);
		},
		_tunguski$elm_ast$Main$testFiles));
var _tunguski$elm_ast$Main$Replace = F3(
	function (a, b, c) {
		return {ctor: 'Replace', _0: a, _1: b, _2: c};
	});
var _tunguski$elm_ast$Main$mainContent = function (model) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		{
			ctor: '::',
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('All items: '),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text(
											_elm_lang$core$Basics$toString(
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html$text(' Success count: '),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html$text(
													_elm_lang$core$Basics$toString(
														A2(_tunguski$elm_ast$Main$countItems, true, model))),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html$text(' Failure count: '),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html$text(
															_elm_lang$core$Basics$toString(
																A2(_tunguski$elm_ast$Main$countItems, false, model))),
														_1: {ctor: '[]'}
													}
												}
											}
										...
										},
										{
											...
											_0: A2(
												...
												{ctor: '[]'},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(
														A2(_elm_lang$core$Basics_ops['++'], 'Package: ', $package.$package)),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
													...
													},
													{
														...
														_0: A2(
															...
															{ctor: '[]'},
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text(
																	A2(_elm_lang$core$Basics_ops['++'], 'Module: ', item.moduleName)),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}),
															...
															_0: A2(
																_elm_lang$html$Html$textarea,
																{
																	...
																	_0: A2(
																		...
																		A2(
																			_elm_lang$core$Json_Decode$map,
																			A2(_tunguski$elm_ast$Main$Replace, $package.$package, item.moduleName),
													...
													_1: {
														...
														_0: A2(
															...
															},
															{
																ctor: '::',
																_0: function () {
																	var _p17 = item.parsed;
																	if (_p17.ctor === 'Just') {
																		return _tunguski$elm_ast$Main$tree(_p17._0);
																	} else {
...
var _tunguski$elm_ast$Main$view = function (model) {
	return A2(
		...
		A2(
			...
			_tunguski$elm_ast$Main$mainContent(model)));
};
var _tunguski$elm_ast$Main$main = _elm_lang$html$Html$program(
	{
		init: _tunguski$elm_ast$Main$init,
		update: _tunguski$elm_ast$Main$update,
		subscriptions: function (m) {
			return _elm_lang$core$Platform_Sub$none;
		},
		view: _tunguski$elm_ast$Main$view
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _tunguski$elm_ast$Main$main !== 'undefined') {
    _tunguski$elm_ast$Main$main(Elm['Main'], 'Main', undefined);
}
